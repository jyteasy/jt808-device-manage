	...
	if err != nil {
		if fn == "conf.json" {
			...
			if ConfigDetail.WebPort == "" {
				ConfigDetail.SocketServerStruct.Port ="10808"
				ConfigDetail.SocketServerStruct.ServerType = "tcp"
				ConfigDetail.SocketServerStruct.SaveFriquent = 60
				ConfigDetail.SocketServerStruct.CacheChanNum = 10000
				ConfigDetail.WebPort = "18090" 
